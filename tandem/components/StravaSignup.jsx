...
export default function StravaSignup({ navigation }) {
	...
	const getActivityData = (code) => {
		fetch(
			`https://www.strava.com/oauth/token?client_id=64734&client_secret=1c40a829591afa728f4d54ed7b2408e11b092d9c&code=${code}&grant_type=authorization_code`,
			{ method: "POST" }
		).then((response) => {
			console.log(response);
